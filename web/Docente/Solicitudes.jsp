            ...
            <div id="content">
                ...
                <div style="justify-content:center;" class="form-row">
                    <div class="form-group col-md-10">
                        <a href="../QueryRequest.do"><input type="button" name="Nueva solicitud" value="Nueva Solicitud" class="btn btn-sm btn-primary"></a>
                        <div class="card my-4">
                            <h5 class="card-header">Solicitudes de aprobación de visitas</h5>
                            <div class="card-body">
                                        ...
                                        <table class="table table-responsive-sm">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <%
                                                        if (map.get("estatus").equals("Proceso")) {

                                                    %>
                                                    <td>
                                                        <a href="../QueryRequest.do?idSolicitud=<%=map.get("idSolicitud")%>"><input type="button" name="Ver" value="Ver" class="btn btn-sm btn-primary"></a>
                                                    </td>
                                                    <%
                                                        }
                                                    %>
