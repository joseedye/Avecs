                                        ...
                                        <table class="table table-responsive-sm">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="tdicon">
                                                        <a href="../UpdateCompany.do?idEmpresaQuery=<%=map.get("idEmpresa")%>" title="Modificar"><i class="fas fa-pencil-alt"></i></a>
                                                    </td>

                                                    <td class="tdicon">
                                                        <a href="#ventana" class="modal-btn" data-some-id="<%=map.get("idEmpresa")%>" title="Eliminar" data-toggle="modal"><i class="fas fa-trash-alt"></i></a>
                                                    </td>                                                                
                                                </tr>                                                                    
