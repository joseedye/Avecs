                                                ...
                                                <tr>
                                                    ...
                                                    <td>                                                           
                                                        <div class="custom-control custom-switch">
                                                            ...
                                                            <input type="checkbox" class="custom-control-input" name="is_public<%=i%>" 
                                                                   <% if (isPublic.equals("true")) { %>
                                                                   checked
                                                                   <% }%> >
                                                            <label onclick="loadCheck(<%=map.get("idDoc")%>,<%=isPublic%>)" class="custom-control-label" name="is_public<%=i%>" for="is_public<%=i%>"></label>
                                                        </div>
                                                    </td>
                                                    <td>
